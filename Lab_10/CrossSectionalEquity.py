...
def make_pipeline():
    ...
    surprise_winsorized = fq0_surprise.winsorize(min_percentile=0.01,
                                              max_percentile=0.99
                                             )
    ...
    growth_factor = estimated_growth_factor.winsorize(min_percentile=0.01,
                                              max_percentile=0.99
                                             )
    ...
    combined_factor = (
        ...
        alpha_winsorized.zscore() +
        surprise_winsorized.zscore() +
        growth_factor.zscore()
    )
